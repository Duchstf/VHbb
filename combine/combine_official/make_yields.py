    ...
    for i in range(len(mass_range)-1):
        ...
        for p in samples:
            ...
            if p not in btag_SF_samples:
                ...
                print(f"Process: {p}, Pass Yield: {hpass.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
                print(f"Process: {p}, Fail Yield: {hfail.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
                ...
                print(f"Process: {p}, Pass Yield: {hpass_qq.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
                print(f"Process: {p}, Fail Yield: {hfail_qq.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
                ...
                print(f"Process: {p}, BB Pass Yield: {hpass_bb.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
                print(f"Process: {p}, BB FAil Yield: {hfail_bb.integrate('systematic', 'nominal').sum('msd1').values()[()]}")
