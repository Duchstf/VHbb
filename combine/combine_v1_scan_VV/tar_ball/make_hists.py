...
def main():
    ...
    for region in regions:
        ...
        #Print sample names
        hist_samples = [x.name for x in sig.integrate('bb1',int_range=slice(ddbthr,1)).sum('msd1').identifiers('process')]
        ...
        for p in samples:
            ...
            hpass = sig.integrate('bb1',int_range=slice(ddbthr,1)).integrate('process',p)
