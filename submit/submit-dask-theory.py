...
python submit/submit-dask-scan.py 2018 > dask.out 2>&1
'''
...
#Import processor
from boostedhiggs import VHbbTheorySystProcessor
tag = "vhbb_theorysyst_v4"
...
year = sys.argv[1]
run_list = ['Diboson', 'HToBB', 'GluGluHToBB', 'VBFHToBBDipoleRecoilOn']
    ...
    with performance_report(filename="dask-report.html"):
        ...
        for this_file in infiles:
            ...
            if os.path.isfile(outfile):
                ...
                #RUN MAIN PROCESSOR
                p = VHbbTheorySystProcessor(year=year, jet_arbitration='T_bvc' , systematics=True)
