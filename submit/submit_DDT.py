'''
To submit processing jobs, do something like

ssh -L 8787:localhost:8787 dhoang@cmslpc125.fnal.gov
grid-proxy-init -valid 1000:00

./shell

python submit/submit_DDT.py 2017 > dask.out 2>&1
'''
...
year = sys.argv[1]
tag = "ddt_map"
run_list = ['QCD'] #Sample to process
    ...
    with performance_report(filename="dask-report.html"):
        ...
        for this_file in infiles:
            ...
            if index in run_list:
                ...
                #RUN MAIN PROCESSOR
                p = DDT(year=year, jet_arbitration='T_bvc')
