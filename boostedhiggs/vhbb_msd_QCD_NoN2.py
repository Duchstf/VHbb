...
#            self._ak4tagBranch = 'btagDeepB'
        ...
        QCD_bins = [round(x,2) for x in list(np.linspace(0,0.5,51))] + [round(x,2) for x in list(np.linspace(0.6,1,5))]
        ...
        self.make_output = lambda: {
            ...
            'ParticleNet_msd': hist.Hist(
                ...
                hist.Bin('qcd1', r'Jet 1 QCD Score', QCD_bins), #20 bins
                hist.Bin('qcd2', r'Jet 2 QCD Score', QCD_bins), #20 bins
            )
        }
