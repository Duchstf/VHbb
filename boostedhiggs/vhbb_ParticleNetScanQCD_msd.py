...
#            self._ak4tagBranch = 'btagDeepB'
        ...
        self.make_output = lambda: {
            ...
            'ParticleNet_msd': hist.Hist(
                ...
                #hist.Bin('pt1', r'Jet 1 $p_{T} [GeV]$', [450, 650, 1200]), #pT split
                hist.Bin('bb1', r'Jet 1 Paticle Net B Score', tagger_bins), # 50 bins
                hist.Bin('cc2', r'Jet 2 Particle Net C Score', tagger_bins), # 50 bins
    ...
    def process_shift(self, events, shift_name):
        ...
        if self._jet_arbitration == 'pt':
            ...
            pnet_cvb = leadingjets.particleNetMD_Xcc / (leadingjets.particleNetMD_Xcc + leadingjets.particleNetMD_Xbb)
            
            # ascending = true                                                                                                                                
            indices = ak.argsort(pnet_cvb,axis=1)
