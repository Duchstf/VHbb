...
class VHbbProcessorV10(processor.ProcessorABC):
...
#            self._ak4tagBranch = 'btagDeepB'
        ...
        qcd_bins = [round(x,4) for x in list(np.linspace(0.,0.2,20))] + [1.] + [0.0922, 0.1002]
        qcd_bins.sort()
    ...
    def process_shift(self, events, shift_name):
        ...
        fatjets['TwoProng'] = 1. - fatjets.particleNetMD_QCD
        ...
        # Pick the first 2 ordering in 2 prong scores
        candidatejets = candidatejets[ak.argsort(candidatejets.TwoProng, axis=1, ascending = False)]
