...
bb_WPs = {'2016APV_bb': [0.0, 0.9737, 0.9883, 1.0],
            '2016_bb':  [0.0, 0.9735, 0.9883, 1.0],
            '2017_bb':  [0.0, 0.9714, 0.9870, 1.0], 
            '2018_bb':  [0.0, 0.9734, 0.9880, 1.0],}
...
class VHbbProcessorMediumWP(processor.ProcessorABC):
