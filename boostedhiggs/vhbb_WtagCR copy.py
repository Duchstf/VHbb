...
class VHBB_WTagCR(processor.ProcessorABC):
    ...
    def process_shift(self, events, shift_name):
        ...
        if self._jet_arbitration == 'qq':
            #Order the jets based on particle net scores
            leadingjets = candidatejets[:, 0:2]
            
            pnet_qq = (leadingjets.particleNetMD_Xcc + leadingjets.particleNetMD_Xbb + leadingjets.particleNetMD_Xqq)/(leadingjets.particleNetMD_Xcc + leadingjets.particleNetMD_Xbb + leadingjets.particleNetMD_Xqq + leadingjets.particleNetMD_QCD)                                                                                       
            indices = ak.argsort(pnet_qq, axis=1, ascending = False) #Higher b score for the Higgs candidate (more b like)                                                            
